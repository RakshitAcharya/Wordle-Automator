...
def main():
    answers = ["scarf","exile","alwyn","betty","kanye","dress","lover","style","lorax","romeo","becky","lakes","piano","karma","peace","maple","clown","ronan","tours","skirt","speak","lorde","blank","fence","jonas","ready","paper","snake","clean","blake","radio","benji","vault","space","dream","seven","blood","album","swift","shake","kitty","story","debut","coney","horse","conor","cruel","heart","curls","lyric","birch","indie","remix","diary","money","drive","woods","spark","lucky","dance","tears","train","beers","award","chart","drunk","banjo","latte","giver","truck","storm","vinyl","songs","harry","music"]
    allowed_guesses = creating_list()
    chances = 1
    fixed = ["_","_","_","_","_"]
    fixed_index = []
    unfixed = []
    ...
    while chances < 7:
        ...
        while(len_flag):
            ...
            if len(word) == 5:
                ...
                l = []
                for x in greys_temp:
                    if (x not in unfixed) and (x not in fixed):
                        l.append(x)
                greys = greys+ l
